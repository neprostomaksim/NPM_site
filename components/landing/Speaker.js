        ...
        <div className="container">
          <div className="expert-grid">
            <Reveal className="photo-frame">
              <Image src="/workshops/speaker.jpg" alt="Максим Леонов — AI-эксперт и ведущий воркшопов" className="speaker-photo" width={667} height={931} sizes="(max-width: 767px) calc(100vw - 40px), 420px" quality={74} />
            </Reveal>
