...
export const metadata = {
  ...
  description: "Максим Леонов — AI-наставник и эксперт по искусственному интеллекту. Воркшопы по ChatGPT и нейросетям, наставничество 1:1, корпоративное обучение ИИ. 350+ учеников.",
  keywords: ["AI наставник", "обучение ИИ", "ChatGPT курс", "промптинг", "нейросети обучение", "ИИ для бизнеса", "воркшоп искусственный интеллект", "Максим Леонов", "Беларусь", "Минск"],
